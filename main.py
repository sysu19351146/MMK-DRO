...
parser.add_argument('--model_name', type=str, default='deit_t_distilled', help='visformer_t, deit_t_distilled')

# data
parser.add_argument('--data_name', type=str, default='MNIST', help="data name")
parser.add_argument('--aug', type=str, default='sgf')
...
parser.add_argument("--iftest", type=bool, default=False )
parser.add_argument("--isvisual", type=bool, default=False )

#visual
parser.add_argument("--image_path", type=str, default="outputs/image/Covid (763).png" )
parser.add_argument("--image_label", type=int, default=1)
parser.add_argument('--outlier_perc', default=50, type=int )
parser.add_argument("--folder_path", type=str, default="outputs/image/show" )
parser.add_argument("--visualize_path", type=str, default="test1" )
...
def main():
    ...
    # data
    if args.data_name[:3]=='COV' or args.data_name[:3]=='PAD' or args.data_name=='ourskin':
        dataloader = dataloaders.__dict__[args.data_name](args.data_dir, args.batch_size)
        val_loader = dataloader.data_loaders()
        dataloader = {
            "train": val_loader,
            "val": val_loader, }
    else:
